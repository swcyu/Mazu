...
sjc_csv = spark.read.format("csv").option("header", "true"). \
    ...
    .load("yogi6/raw_data/crawling/init/sjc_all.csv")
'''
sjc_csv = spark.read.format("csv").option("header", "true"). \
    option("multiline", "true").option("quote", "\"").option("escape", "\"") \
...
df_final.write.format('parquet').mode("overwrite").save("hdfs:///user/ubuntu/yogi6/tr_data/crawling/init/sjc.parquet")