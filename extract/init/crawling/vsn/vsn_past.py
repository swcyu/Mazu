...
target_url ='https://korean.visitseoul.net/exhibition?curPage=1&srchType=&srchOptnCode=&srchCtgry=&sortOrder=&srchSchdul=C&srchBgnDe=&srchEndDe=&srchWord='
...
for page_num in range(1, last_page_num+1):
    target_url = f'https://korean.visitseoul.net/exhibition?curPage={page_num}&srchType=&srchOptnCode=&srchCtgry=&sortOrder=&srchSchdul=C&srchBgnDe=&srchEndDe=&srchWord='
    driver.get(target_url)
    sleep(3)
    #8개의 전시들 선택
...
VSN_df.to_csv('visitSeoulNet_past.csv', encoding="utf-8-sig")